...
public class EasySSLProtocolSocketFactory implements SecureProtocolSocketFactory
{
  ...
  /**
   * @see SecureProtocolSocketFactory***REMOVED***createSocket(String,int,java.net.InetAddress,int)
   */
  ...
  /**
   * @see SecureProtocolSocketFactory***REMOVED***createSocket(String,int)
   */
  ...
  /**
   * @see SecureProtocolSocketFactory***REMOVED***createSocket(java.net.Socket,String,int,boolean)
   */
